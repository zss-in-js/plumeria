...
export const Box = () => {
  return (
    <div className={css.props(styles.container)}>
      <span>
        hover
        <span tabIndex={0} className={css.props(styles.card, styles.hover)} />
      </span>
      <span>
        focus
        <span tabIndex={0} className={css.props(styles.card, styles.focus)} />
      </span>
    </div>
  );
};
...
export function FancyButtons() {
  return (
    <div className={css.props(styles.stack)}>
      <button className={css.props(styles.button, styles.hover, styles.focusPurple)}>Purple</button>
      <button className={css.props(styles.button, styles.hover, styles.focusSky)}>Sky</button>
      <button className={css.props(styles.button, styles.hover, styles.focusGreen)}>Green</button>
    </div>
  );
}
```
