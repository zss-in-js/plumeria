...
## 🔧 Example: Flexbox with modifiers
...
export const composed = css.createComposite(styles.flexBox, {
  hover: {
    [css.pseudo.hover]: {
      scale: 1.5,
    },
...
// component.tsx
import { composed } from './styles'

export function Box() {
  return <div className={composed.hover} />
}
```
</Tab>
</Tabs>

## 💡 Why use `createComposite()`?
...
- Grows linearly — like Atomic CSS — where shared logic doesn't increase output size
