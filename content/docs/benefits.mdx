...
In Vite, just remove `type: "module"` and change it to `vite.config.mts` and it will work.  
...
✔️ Compatible with static site generators and server-side caching strategies.
