...
- 5aec304: - Fix a bracket group losing the other groups' styles when the selected key carries none of the conflicting properties, because the combination table had no cell for that key
