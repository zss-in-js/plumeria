...
- e71ab6f: Update npm core README.md
...
- 0b56e62: Fix: fix use function and export CSSProperties
...
- 3f7305f: Fix export in types.d.ts
...
- 08751c3: The createTheme API has been revamped
...
- 614dd91: chore: description and readme update
...
- 749fe8e: chore: description readme headling update
...
- 923c2aa: chore: Exporting internal types is no longer supported
...
- 0536734: chore: package.json files types/
...
- 8dbc46b: fix: improved marker and extended types
...
- 21c43f3: feat: rx function is renamed to x
...
- 09f477b: feat: added TSDocs to the API and porting overrideLonghand in create.ts to zss-engine
...
- 584e992: refactor: fit to 25kB for npm bundle size
...
- 9a0a31d: chore: removed the code related to the commented out tests
...
- a8af963: feat: readme.md updated
...
- 5c19c0d: feat: dependencies update
...
- 878c4e0: fix: core update fix client injection to not overwrite atoms when using nextjs
...
- 0a44427: fix: readme update v0.15.1
