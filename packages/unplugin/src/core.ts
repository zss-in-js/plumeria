...
export interface PluginOptions {
  ...
  /**
   * When enabled, CSS is written to a real file on disk (`zero-virtual.css`)
   * instead of using virtual modules during development.
   *
   * This is useful for RSC frameworks (e.g. Waku) that require CSS to exist
   * as a real file on the file system, and for bundlers (e.g. Farm) that have
   * limited virtual module HMR support.
   *
   * Farm always uses disk emission regardless of this option.
   *
   * @default false
   */
