---
title: 'Color'
description: 'Every CSS named color with its hex code and a note on where it fits.'
---
...
## Overview
Plumeria's style types autocomplete the 141 CSS named colors, and `validate-values` in [`@plumeria/eslint-plugin`](/docs/api-reference/plugins/eslint-plugin) checks color values against the same list. The full list is below.
