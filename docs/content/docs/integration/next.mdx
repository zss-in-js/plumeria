---
title: 'Next.js'
description: 'Add Plumeria to a Next.js project, with one command or by hand.'
---
...
`npx @plumeria/init` detects Next.js and writes this setup for you; see [@plumeria/init](/docs/api-reference/tools/init). The rest of this page is the same setup by hand.
...
If you set a custom `styleProp` (such as `'sx'`), declare that name instead, and keep it the same as the one in `next.config.ts`; see [Declaring the styling prop](/docs/api-reference/types/Style#declaring-the-styling-prop).

<Cards>
  <Card title="Shipping this as a component library" href="/docs/integration/component-library" />
  <Card title="See more about Installation" href="/docs/installation" />
</Cards>
