...
[`@plumeria/next-plugin`](https://www.npmjs.com/package/@plumeria/next-plugin) is the Next plugin for Plumeria.  
It compiles styles into CSS via AST parsing, with HMR support.  
Using [@plumeria/turbopack-loader](/docs/integration/turbopack) and [@plumeria/webpack-plugin](/docs/integration/webpack).
