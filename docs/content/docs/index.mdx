...
Plumeria is a JavaScript and TypeScript syntax and compiler's atomic Zero-runtime CSS-in-JS library.  
Build optimized styles using collision-free atomic CSS, refactoring less and scaling the number of components optimistically.
It helps developers focus on **what** to style, not **how** to style it.  
Which is more efficient than what you can create and manage manually.
