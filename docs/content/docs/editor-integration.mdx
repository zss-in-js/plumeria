...
<Steps>
<Step>
## className snippet for style macro
In VS Code, create a snippet that expands `css.use()` inside `className`.  
`shift + command + p >`  
...
The Plumeria linter is the [`@plumeria/eslint-plugin`](https://www.npmjs.com/package/@plumeria/eslint-plugin) package.  
