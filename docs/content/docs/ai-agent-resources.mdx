...
| Components | Headless UI integration and the development inspector | [Open section](/docs/api-reference#components) · [Markdown](/docs/api-reference.md#components) |
| Plugins and tools | Next.js, unplugin, ESLint, and codemods | [Open section](/docs/api-reference#plugins) · [Markdown](/docs/api-reference.md#plugins) |
