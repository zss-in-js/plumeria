...
1. Installation — https://plumeria.dev/docs/installation.md
...
https://plumeria.dev/docs/installation.md
...
https://plumeria.dev/docs/selector-rules.md
https://plumeria.dev/docs/specificity.md
...
https://plumeria.dev/docs/editor-integration.md
...
https://plumeria.dev/docs/api-reference/tools/codemod.md
```
...
| :-- | :-- | :-- |
| Getting started | Installation, selector rules, editor and ESLint setup | [Open section](/docs/installation) · [Markdown](/docs/installation.md) |
| Core concepts | Why Plumeria, compile-time behavior, composition | [Introduction](/docs.md) · [Why Plumeria?](/docs/why-plumeria.md) · [Composition laws](/docs/composition-laws.md) |
| JavaScript API | `create`, static styles, themes, keyframes, markers, transitions, and `use` | [Open section](/docs/api-reference#javascript-api) · [Markdown](/docs/api-reference.md) |
| Components | Headless UI integration and the development inspector | [Open section](/docs/api-reference#components) · [Markdown](/docs/api-reference.md) |
| Plugins and tools | Next.js, unplugin, ESLint, and codemods | [Open section](/docs/api-reference#plugins) · [Markdown](/docs/api-reference.md) |
...
| CSS reference | Specificity, colors, and supported pseudo-selectors | [Open section](/docs/specificity) · [Markdown](/docs/specificity.md) |
