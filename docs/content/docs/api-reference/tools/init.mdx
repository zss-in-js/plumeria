---
title: '@plumeria/init'
description: 'One command that picks the right packages and plugin for your bundler.'
---
...
<Cards>
  <Card title="Set it up by hand instead" href="/docs/installation" />
  <Card title="Move an existing codebase onto Plumeria" href="/docs/api-reference/tools/codemod" />
</Cards>
