...
description: 'Install and configure the bundler plugin behind every integration except Next.js.'
---
...
[Specificity](/docs/specificity) explains why the pair cannot be
