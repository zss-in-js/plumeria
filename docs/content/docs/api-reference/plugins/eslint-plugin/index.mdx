---
title: 'Recommended'
description: 'The recommended rules, type-aware selector checks, and the styling prop setting.'
---
...
<Cards>
  <Card title="See more about Editor integration" href="/docs/editor-integration" />
</Cards>
