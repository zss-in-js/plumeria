...
description: 'Wrapper component library that seamlessly integrates Radix UI with Plumeria classStyle abstraction layer.'
---
...
Please refer to the [Installation](/docs/installation) section for details.
