...
description: 'Hover any element to see the Plumeria rules applied to it, in development or on staging.'
---
...
<Inspector />
`@plumeria/inspector` is a component you render once. It outlines the element under the cursor and shows the Plumeria rules applied to it, in the browser.
