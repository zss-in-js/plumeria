---
title: 'Plumeria v7.2.4: Compile-time Only'
description: 'Towards a complete Compile-time Library. Plumeria v7.2.4 abolishes runtime code entirely, shifting to an architecture that stands solely on type definitions and static extraction. (4 min read)'
date: '2026-01-29'
---
