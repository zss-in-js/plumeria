...
The full reference for both directions — every report kind, what it means, and what to do about it — is in [`@plumeria/codemod`](/docs/api-reference/tools/codemod).
