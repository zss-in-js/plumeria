...
Fixes from 18.2.20 through 18.2.27 closed the round trip. Exporting, adopting, and exporting again now reaches a fixed point on the second pass in each direction. See the [codemod documentation](/docs/codemod) for supported conversions and reports.
...
<Cards>
  ...
  <Card title="Codemod" href="/docs/codemod" description="Migrate between Plumeria and CSS Modules" />
