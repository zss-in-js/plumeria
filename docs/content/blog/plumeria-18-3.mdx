...
Fixes from 18.2.20 through 18.2.27 closed the round trip. Exporting, adopting, and exporting again now reaches a fixed point on the second pass in each direction. See the [codemod documentation](/docs/api-reference/tools/codemod) for supported conversions and reports.
...
The complete cascade model is documented in [Specificity](/docs/specificity).
...
<Cards>
  ...
  <Card title="Codemod" href="/docs/api-reference/tools/codemod" description="Migrate between Plumeria and CSS Modules" />
  <Card title="Specificity" href="/docs/specificity" description="Understand property, condition, and composition priority" />
