---
title: 'The tools are eating up the libraries'
date: '2026-05-10'
---
...
<div style={{ display: 'flex', gap: 16, margin: '24px 0' }}>
  <GitHubUser username="refirst11" subtext="Plumeria Core" />
</div>

Plumeria was originally a library.  
More specifically, it was a pure library of the evalucation AOT-compiled type that evaluates and executes at runtime.
...
The actual JavaScript portion consists solely of `export {}`
in reality, excluding the static parts, this code does not exist as JavaScript.
...
What remained was a simple yet powerful constraint — that it doesn't run at runtime. The constraint itself has no shape. No code. Just a rule.

Interfaces and the bundler. Linting is extremely useful for interfaces.

So where is the real core, after all?

After building Plumeria with everything included, what I finally realized was that the equation Plumeria === undefined is true.
