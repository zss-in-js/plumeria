...
This version can be considered an LTS.
One of the reasons we haven't upgraded zss-engine is that it's easy to improve, but we plan to upgrade it to 0.3.0 within 0.2.130.
