  ...
  return (
    <div className={style.use(styles.container)}>
      <div className={style.use(styles.card)}>
        <div className={style.use(styles.avatar)}>🦊</div>
        <h2 className={style.use(styles.name)}>Kitsune</h2>
        <p className={style.use(styles.bio)}>
          🍜 Plumeria artist ·  Designing rich experiences with CSS-in-JS
        </p>

        <div className={style.use(styles.statsContainer)}>
          <div className={style.use(styles.statItem)}>
            <div className={style.use(styles.statValue)}>128</div>
            <div className={style.use(styles.statLabel)}>posts</div>
          </div>
          <div className={style.use(styles.statItem)}>
            <div className={style.use(styles.statValue)}>1.2k</div>
            <div className={style.use(styles.statLabel)}>followers</div>
          </div>
          <div className={style.use(styles.statItem)}>
            <div className={style.use(styles.statValue)}>350</div>
            <div className={style.use(styles.statLabel)}>following</div>
          </div>
        </div>
